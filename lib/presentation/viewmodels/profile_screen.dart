...
class TripViewModel extends ChangeNotifier {
  ...
  Future<void> fetchTrips({required String from, required String to}) async {
    ...
    try {
      ...
      _searchError = 'Ошибка поиска. Попробуйте ещё раз.';
    }
    notifyListeners();
  }
  ...
  Future<bool> handleJoinRequest(String tripId) async {
    ...
    try {
      ...
      _bookingState = result ? ViewState.success : ViewState.error;
      if (!result) _bookingError = 'Не удалось забронировать поездку.';
      notifyListeners();
      return result;
    } catch (e) {
